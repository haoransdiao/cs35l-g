...
class UploadButton extends Component {
    ...
    onFileUpload = () => {
        ...
        formData.append("title", this.state.selectedFile.title)
        formData.append("description", this.state.selectedFile.description)
        formData.append("tags", this.state.selectedFile.tags)
